          ...
          <div className="col-12 col-sm-12 col-md-3 col-lg-3 sidebar filterbar">
            ...
            <div className="sidebar_tags">
              ...
              <div className="sidebar_widget filterBox filter-widget size-swacthes">
                <div className={`widget-title ${activeMenu["size"] ? "active" : ""  }`} onClick={() => toggleSubMenu("size")}>
                  <h2>Size</h2> 
                </div>
              ...
              {/*Color Swatches*/}
              <div className="sidebar_widget filterBox filter-widget">
                <div className={`widget-title ${activeMenu["color"] ? "active" : ""  }`} onClick={() => toggleSubMenu("color")}>
                  <h2>Color</h2>
                </div>
                <div className={`filter-color swacth-list clearfix ${activeMenu["color"] ? "d-block" : "d-none"}`}>
              ...
              {/*Brand*/}
              <div className="sidebar_widget filterBox filter-widget">
                <div className={`widget-title ${activeMenu["brands"] ? "active" : ""  }`} onClick={() => toggleSubMenu("brands")}>
                  <h2>Brands</h2>
                </div>
                    ...
                    <div className="col-4 col-md-4 col-lg-4 text-right">
                      <div className="filters-toolbar__item">
                        <label htmlFor="SortBy" className="hidden">
                          Sort
                          {/* <FontAwesomeIcon className="d-block" icon={faCaretDown} /> */}
                        </label>
                        <select
                          name="SortBy"
                          id="SortBy"
